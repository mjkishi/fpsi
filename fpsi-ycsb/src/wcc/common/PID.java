...
/**
 * Keeps data related with process like id, hostname and port numbers required
 * for processes to communicate with each other, and by clients to connect to
 * replicas.
 */
public class PID {
	 ...
	 * @param replicaPort - port number used by other processes
