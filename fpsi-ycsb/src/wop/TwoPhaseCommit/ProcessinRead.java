...
public class ProcessinRead {
	...
	public void onRead(Read msg, int sender) throws IOException{ 
		...
		ReadAns m=new ReadAns(msg,objByte,maxVCByte ,this.numNodes,msg.getRetryTimes(),msg.getIsUpdate(), response.getSiteId(), response.getObjSeqNo());
	...
	public void onReadAns(ReadAns msg, int sender){
		byte[] obj=msg.getObj();
		AbstractObject object=wccInstance.getSTMService().deserializeObject(obj);
